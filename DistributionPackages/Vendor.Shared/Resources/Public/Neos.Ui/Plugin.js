...
/***/ "./lib/VideoParser/VideoParser.js":
/*!****************************************!*\
  !*** ./lib/VideoParser/VideoParser.js ***!
  \****************************************/
...
function validator(videoConfig) {
...
var Preview = function Preview(props) {
    ...
    var labelAspectRatio = (_c = {
        ratio_16_9: "16:9",
        ratio_16_10: "16:10",
        ratio_4_3: "4:3"
    }[(_b = (_a = props.value) === null || _a === void 0 ? void 0 : _a.aspectRatio) !== null && _b !== void 0 ? _b : ""]) !== null && _c !== void 0 ? _c : "";
    return React.createElement(IconCard, { icon: "play", title: props.value.platformIdentifier, subTitle: "Format: " + labelAspectRatio + ", ID: " + props.value.identifier });
};
exports.Preview = Preview;
var parseUrl = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(input) {
        var _a, _b, _c, videoConfig, inputWithEnforcedProtocol, url;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        videoConfig = {};
                        inputWithEnforcedProtocol = ("https://" + input).replace(/^https:\/\/http(s)*:\/\//g, "https://");
                        url = new URL(inputWithEnforcedProtocol);
                        _context2.t0 = true;
                        _context2.next = _context2.t0 === (url instanceof URL && /youtube.com/.test(url.hostname) && /shorts/.test(url.pathname)) ? 6 : _context2.t0 === (url instanceof URL && /youtube-nocookie.com/.test(url.hostname) && /embed/.test(url.pathname)) ? 9 : _context2.t0 === (url instanceof URL && /youtube.com/.test(url.hostname)) ? 12 : _context2.t0 === (url instanceof URL && /youtu.be/.test(url.hostname)) ? 15 : _context2.t0 === (url instanceof URL && /vimeo.com/.test(url.hostname)) ? 18 : 21;
                        break;
                    ...
                    case 12:
                        ...
                        if (url.searchParams.get("v")) {
                            videoConfig.identifier = (_a = url.searchParams.get("v")) !== null && _a !== void 0 ? _a : "";
                        }
                        return _context2.abrupt("break", 22);

                    case 15:
                        videoConfig.platformIdentifier = "YouTube";
                        videoConfig.identifier = ((_b = url.pathname) !== null && _b !== void 0 ? _b : "/").slice(1);
                        return _context2.abrupt("break", 22);

                    case 18:
                        videoConfig.platformIdentifier = "Vimeo";
                        videoConfig.identifier = ((_c = url.pathname) !== null && _c !== void 0 ? _c : "/").slice(1);
                        return _context2.abrupt("break", 22);
                    ...
                    case 22:
                        return _context2.abrupt("return", videoConfig);
...
var Form = function Form(props) {
    ...
    var _props$api = props.api,
        ...
        _props$api$ReactFinal = _props$api.ReactFinalForm,
        useForm = _props$api$ReactFinal.useForm,
        useFormState = _props$api$ReactFinal.useFormState;
    ...
    var _React$useState = React.useState(""),
        ...
        checkInput = _React$useState2[0],
        setCheckInput = _React$useState2[1];

    var _React$useState3 = React.useState(null),
        _React$useState4 = _slicedToArray(_React$useState3, 2),
        videoConfig = _React$useState4[0],
        setVideoConfig = _React$useState4[1];
    ...
    React.useEffect(function () {
        var isActive = true;
        if (checkInput === null || checkInput === void 0 ? void 0 : checkInput.length) {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return parseUrl(checkInput);

                            case 2:
                                videoConfig = _context3.sent;
    ...
    React.useEffect(function () {
        var _a, _b;
        change("platformIdentifier", (_a = videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.platformIdentifier) !== null && _a !== void 0 ? _a : "");
        change("identifier", (_b = videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.identifier) !== null && _b !== void 0 ? _b : "");
    }, [videoConfig]);
    return React.createElement(Layout.Stack, null, React.createElement(ReactFinalForm.Form, { onSubmit: function onSubmit() {} }, function (props) {
        return React.createElement("form", { className: "sg-ig-space-y-4", style: { maxWidth: "90vw", minWidth: "550px" }, onSubmit: props.handleSubmit }, React.createElement("div", { className: "sg-ig-space-y-4" }, React.createElement(ReactFinalForm.Field, { name: "checkInput" }, function (_ref3) {
            var input = _ref3.input,
                meta = _ref3.meta;
            return React.createElement("div", { className: "fix-neos-ui-validation-messages" }, React.createElement(neos_ui_editors_1.EditorEnvelope, { identifier: "Sitegeist-InspectorGadget-" + input.name, label: "Video-URL (einfach aus dem Browser kopieren)", editor: "Neos.Neos/Inspector/Editors/TextFieldEditor", validationErrors: meta.error ? [meta.error] : [], value: checkInput, commit: setCheckInput }));
        })));
    }), React.createElement("div", { className: "sg-ig-space-y-4" }, (videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.platformIdentifier) && ((_a = videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.identifier) === null || _a === void 0 ? void 0 : _a.length) ? React.createElement(React.Fragment, null, React.createElement("b", null, "Aktuelles/Erkanntes Video:"), React.createElement(Layout.Columns, { columns: 2 }, React.createElement("span", null, "Plattform:"), React.createElement("span", null, videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.platformIdentifier), React.createElement("span", null, "Video-ID:"), React.createElement("span", null, videoConfig === null || videoConfig === void 0 ? void 0 : videoConfig.identifier))) : checkInput.length > 0 && React.createElement(React.Fragment, null, React.createElement("b", null, "Diese URL ist uns unbekannt und wir k\xF6nnen keine Video-Parameter erkennen."), React.createElement("div", null, "Versuchen Sie eines der folgenden Schemata:"), React.createElement("ul", null, React.createElement("li", null, "www.youtube.com/?v=123"), React.createElement("li", null, "www.youtube.com/shorts/123"), React.createElement("li", null, "www.youtube-nocookie.com/embed/123?rel=0"), React.createElement("li", null, "youtu.be/123"), React.createElement("li", null, "vimeo.com/123")))), React.createElement(Layout.Columns, { columns: 2 }, React.createElement(Field, { name: "aspectRatio", label: "Aspect Ratio", editor: "Neos.Neos/Inspector/Editors/SelectBoxEditor", defaultValue: "ratio_16_9", editorOptions: {
            values: Object.entries(KNOWN_RATIOS).reduce(function (memo, _ref4) {
                var _ref5 = _slicedToArray(_ref4, 2),
                    key = _ref5[0],
                    label = _ref5[1];

                return Object.assign(Object.assign({}, memo), _defineProperty({}, key, { label: label }));
            }, {})
        } })));
};
exports.Form = Form;
//# sourceMappingURL=VideoParser.js.map

/***/ }),

/***/ "./lib/VideoParser/index.js":
/*!**********************************!*\
  !*** ./lib/VideoParser/index.js ***!
  \**********************************/
/*! no static exports found */
...
exports.VideoParser = __importStar(__webpack_require__(/*! ./VideoParser */ "./lib/VideoParser/VideoParser.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.VideoParser = void 0;
var VideoParser_1 = __webpack_require__(/*! ./VideoParser */ "./lib/VideoParser/index.js");
Object.defineProperty(exports, "VideoParser", { enumerable: true, get: function get() {
    return VideoParser_1.VideoParser;
  } });
//# sourceMappingURL=index.js.map
...
(0, _neosUiExtensibility2.default)('@vendor/shared-editors', {}, function (globalRegistry) {
	var editorsRegistry = globalRegistry.get('@sitegeist/inspectorgadget/editors');

	editorsRegistry.set('Vendor\\Shared\\Domain\\PlatformVideoId', _lib.VideoParser);
});
